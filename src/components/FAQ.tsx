...
export function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 px-4 sm:px-6 md:px-12 lg:px-24 xl:px-28 2xl:px-36 bg-transparent border-t border-black/10 dark:border-white/10 relative z-10">
